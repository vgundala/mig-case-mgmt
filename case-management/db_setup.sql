...
INSERT INTO APP_USERS (USER_ID, USERNAME, PASSWORD, ROLE) VALUES (APP_USERS_SEQ.NEXTVAL, 'manager', 'password', 'SALES_MANAGER'); -- Note: Use a hashed password in a real application

-- Create some Sales People
INSERT INTO APP_USERS (USER_ID, USERNAME, PASSWORD, ROLE) VALUES (APP_USERS_SEQ.NEXTVAL, 'sales1', 'password', 'SALES_PERSON');
INSERT INTO APP_USERS (USER_ID, USERNAME, PASSWORD, ROLE) VALUES (APP_USERS_SEQ.NEXTVAL, 'sales2', 'password', 'SALES_PERSON');

-- Create some new leads
INSERT INTO LEADS (LEAD_ID, LEAD_NAME, COMPANY, EMAIL, PHONE, STATUS, POTENTIAL_VALUE)
VALUES (LEADS_SEQ.NEXTVAL, 'John Smith', 'ABC Corp', 'john.smith@abccorp.com', '123-456-7890', 'NEW', 50000);

INSERT INTO LEADS (LEAD_ID, LEAD_NAME, COMPANY, EMAIL, PHONE, STATUS, POTENTIAL_VALUE)
VALUES (LEADS_SEQ.NEXTVAL, 'Jane Doe', 'XYZ Inc', 'jane.doe@xyzinc.com', '098-765-4321', 'NEW', 1500000);
